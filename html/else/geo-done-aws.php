...
$category=htmlspecialchars($staff_category);


if($address=='')
{

  header("Location: http://www.mosio.me/falca/");
  exit();
}
else
{
...
if ($xml->status == 'OK') {
  ...
  header("Location: http://www.mosio.me/falca/items/maps?lat=$lat&lng=$lng&purp=$purp&category=$category");
  exit();
}
