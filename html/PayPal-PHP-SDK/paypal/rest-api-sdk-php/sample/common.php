...
class ResultPrinter
{
   ...
   $headerurl = $_SERVER['REQUEST_URI'];
    $headersearch = strstr($headerurl, "CreatePaymentUsingPayPal.php");
    if ($headersearch) {
...
else
{
	...
	echo $response->transactions[0]->description;
	echo '/';
	echo $response->transactions[0]->item_list->items[0]->name;
	echo '/';
	echo $response->transactions[0]->item_list->items[0]->quantity;
}
